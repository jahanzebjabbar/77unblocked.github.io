...
function addBtnHome() {
 ...
 if (referrer.indexOf("https://77gamesio.github.io/") !== -1) {
  ...
  e.id = 'inGame';
  e.innerHTML = `
    <img src="https://77gamesio.github.io/76ez.png" width="150px" height="60px" alt="77 Games io">`;
...
function returnHome(){
    ...
    var newWindow = window.open("https://77gamesio.github.io", "");
    newWindow.document.title = "77 Games io";
}
function opendiscord(){
    window.open("https://77gamesio.github.io");
}
